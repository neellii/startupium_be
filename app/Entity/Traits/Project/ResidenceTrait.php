...
trait ResidenceTrait {
    ...
    {
        return $this->belongsToMany(City::class, 'project_residence_ref');
    }

    public function region()
    {
        return $this->belongsToMany(Region::class, 'project_residence_ref');
    }

    public function country()
    {
        return $this->belongsToMany(Country::class, 'project_residence_ref')
